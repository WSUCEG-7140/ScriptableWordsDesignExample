...
///////////////////////////////////////////////////////////////////////////////
/// Immutable test data
static const Pet s_pets[5]{
    {12, "Hershey"}, {15, "Jade"}, {14, "Abby"}, {12, "Sooner"}, {2, "Elsa"}};
...
///////////////////////////////////////////////////////////////////////////////
TEST(memoryoperations, memmoveCopy) { // verify that memmove actually copies
...
TEST(memoryoperations,
     memmoveCopyOverSelf) { // verify copy collection over itself does not
                            // change collection
  Pet pets[s_petsNumber];
  MemoryOperations::memmove(pets, s_pets, s_petsNumber);
...
///////////////////////////////////////////////////////////////////////////////
TEST(memoryoperations,
     memmoveCopyOverSelfNext) { // verify copy each item to next index within
                                // same collection
  Pet pets[s_petsNumber];
  MemoryOperations::memmove(pets, s_pets, s_petsNumber);
...
///////////////////////////////////////////////////////////////////////////////
TEST(memoryoperations,
     memmoveCopyLast) { // verify whatever is copied last replaces content
...
///////////////////////////////////////////////////////////////////////////////
TEST(memoryoperations,
     memmoveReturnValue) { // verify address returned from memmove()
  Pet pets[s_petsNumber];
  GTEST_ASSERT_EQ(pets, MemoryOperations::memmove(pets, s_pets, s_petsNumber));
}

///////////////////////////////////////////////////////////////////////////////
TEST(memoryoperations,
     memmoveCopyOverSelfPrevious) { // verify copy each item to previous index
